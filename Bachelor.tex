...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% Dijkstra proof %%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textbf{Proving the correctness of Dijkstra's algorithm}\\
...
%In your modified Dijkstra, the set S plays a very different role. It is the set of vertices v for which we have considered a path to v... that is, for some vertex u, we extracted u and relaxed the edge (u,v). Basically, V-S is exactly the set of vertices that in the original Dijkstra would have d[v]=infinity.
